    ...
    <>
     <div style={{width:'100%', height:'100vh', backgroundColor:'black'}} className='d-flex justify-content-center align-items-center'>
        <div className='bg-light p-5 rounded ' style={{width:'500px'}}>
          ...
          <div onClick={() => dispatch(increament())} className='btn btn-warning'>INCREMENT</div>
          <div onClick={() => dispatch(decrement())} className='btn btn-danger'>DECREMENT</div>
          <div onClick={() => dispatch(reset())} className='btn btn-success'>RESET</div>
